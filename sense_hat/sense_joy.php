...
echo shell_exec("./python/sensor.py $h_flag $t_flag $p_flag 2>&1"); #executing python script with given attributes
echo ", <br>";
...
echo shell_exec("./python/rot.py $r_flag $pi_flag $y_flag $u_flag 2>&1");
